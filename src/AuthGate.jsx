  ...
  return (
    ...
    >
      ...
      <div className="max-w-md md:max-w-2xl lg:max-w-3xl mx-auto px-6 md:px-10 pt-16 pb-14">
        ...
        <p className="text-sm text-neutral-400 text-center mb-4 max-w-md mx-auto leading-relaxed">
          Just promoted and nobody trained you?{" "}
          <a href="/new-manager-coach" className="underline font-semibold" style={{ color: ACCENT }}>
            Start here
          </a>
          .
        </p>
        <p className="text-sm text-neutral-400 text-center mb-14 max-w-md mx-auto leading-relaxed">
          Built by a Navy veteran and eighteen-year frontline operator who learned this the
          wrong way first.{" "}
          <a href="/operator" className="underline font-semibold" style={{ color: ACCENT }}>
            Read why I built it
          </a>
          .
        </p>
